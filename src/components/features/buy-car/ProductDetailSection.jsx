...
export default function ProductDetailSection({ data = product_detail_data }) {
  ...
  return (
    <section className="w-full h-auto py-[20px_50px] sm:py-[20px_50px] lg:py-[20px_70px] 2xl:py-[25px_80px] 3xl:py-[30px_100px] mt-[var(--header-y)] border-t-1 border-[#808080]/50 block">
