...
export default function PremiumSection({ data }) {
    ...
    return (
        premium_showroom_section?.enable__disable_premium_section === true ? (
            <section className="w-full h-full min-h-[300px] sm:min-h-[450px] xl:min-h-[550px] 2xl:min-h-[650px] 3xl:min-h-[750px] relative 
                ...
                after:bg-[linear-gradient(270deg,#000_0%,rgba(0,0,0,0)_100%)] ">
                    <Image src={premium_showroom_section?.image?.url} width="1400" height="890" className="w-full h-full object-cover opacity-20" alt={premium_showroom_section?.image?.alt}/>
                </div>
                {/* title */}
