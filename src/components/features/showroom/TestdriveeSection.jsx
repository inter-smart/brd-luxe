                ...
                <div className="flex flex-wrap -m-[5px] xl:-m-[8px] 2xl:-m-[10px] 3xl:-m-[15px] mb-[25px] lg:!mb-[35px] 2xl:!mb-[45px] 3xl:!mb-[55px]">
                        ...
                        <div className="w-full h-full p-[15px] lg:p-[30px_25px] xl:p-[35px_25px] 2xl:p-[40px_25] bg-gradient-to-tr 
                            ...
                            <div className="w-full lg:w-[120px] xl:w-[150px] 2xl:w-[180px] 3xl:w-[230px] flex-items-center justify-center">
                                <div className="w-full h-full flex items-center justify-center max-lg:max-w-[125px] m-auto" >
                                    <Image src="/images/logo.svg" width="225" height="65" alt="logo" />
                                </div>
                            </div>
                    ...
                    <div className="w-full sm:w-1/2 p-[5px] xl:p-[8px] 2xl:p-[10px] 3xl:p-[15px]">
                        <div className="w-full h-full p-[25px] lg:p-[30px_25px] xl:p-[35px_25px] 2xl:p-[40px_25] bg-gradient-to-tr 
                            ...
                            <div className="p-[5px] max-lg:w-full">
                               <Link href="/" className="text-[12px] sm:text-[10px]  2xl:text-[15px] 3xl:text-[18px] leading-[1] 
                               ...
                               duration-300 ease-in-out max-lg:m-auto block">Book a Test Drive</Link>
                            </div>
