...
export default function FlagshipSection() {
    const slides = createSlideGroups(flagShip);
    const placeholder = "/images/placeholder.jpg";
    const img = (group, n) => group[n]?.image ?? placeholder;
            ...
            <div className="container">
                ...
                <div className="relative">
                                            ...
                                            <div className="w-1/2 h-full flex flex-col gap-1 lg:gap-3">
                                                <div className="relative w-full h-1/2 overflow-hidden">
                                                    <div className="w-full h-full ">
                                                        <Image src={img(group, 0)} alt="" fill className="object-cover" />
                                                    </div>
                                                </div>
                                                <div className="relative w-full h-1/2 overflow-hidden">
                                                    <div className="w-full h-full">
                                                        <Image src={img(group, 1)} alt="" fill className="object-cover" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="relative w-1/2 h-full overflow-hidden">
                                                <Image src={img(group, 2)} alt="" fill className="object-cover" />
                                            </div>
                                        </div>
                                    ) : (
                                        // Layout B
                    ...
                    <div className="flex items-center justify-center absolute top-0 bottom-0 w-full">
                        <button className="btn-prev absolute left-[0px] lg:left-[-55px] lg:top-1/2 lg:-translate-y-1/2 z-10
                        ...
                        <button className="btn-next absolute right-[0px] lg:right-[-55px] lg:top-1/2 lg:-translate-y-1/2 z-10 
                            bg-gradient-to-r from-[#E4E4E4] to-[#FFFFFF] 
