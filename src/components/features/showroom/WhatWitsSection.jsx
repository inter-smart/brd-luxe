    ...
    return (
            <section className="pb-[40px] lg:pb-[65px] xl:pb-[85px] 2xl:pb-[90px] 3xl:pb-[130px]">
                <div className="container">
                    ...
                    dangerouslySetInnerHTML={{ __html: what_awaits_you_section?.title || "" }}
                    />
                        ...
                        >
                            {items.map((item, index) => (
                                <SwiperSlide key={index} className="!h-auto">
                                    <div className="w-full h-full p-[10px_20px] xl:p-[15px_20px] 2xl:p-[20px] 3xl:p-[25px_30px] bg-gradient-to-tr 
                                    ...
                                    <h3 className="text-[12px] sm:text-[14px] sm:leading-[14px] xl:text-[20px] xl:leading-[20px]  2xl:text-[24px] 2xl:leading-[30px]  
