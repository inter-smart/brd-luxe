...
export default function OfferSectionClient({ data }) {
            ...
            ? part
                ...
                .map((text, j) =>
                  text.toLowerCase() === phrase.toLowerCase() ? (
                    <span key={`${i}-${j}`} className="text-[#E09812]">
                      {text}
                    </span>
                  ) : (
                    text
  ...
  return (
    ...
    >
      <div ref={overlayRef} className="w-full h-full absolute inset-0 z-0"></div>
      ...
      <div className="container w-full h-full">
        <div className="w-full h-full relative z-0">
          <div ref={topHeaderRef} className="text-center md:w-[50%] mx-auto max-md:mb-[35px] relative z-2">
            <Heading
              as="h1"
            ...
            >
              {handleHighlight(offers_section?.heading, offers_section?.highlighted_word)}
            </Heading>
          ...
          >
            <Heading as="h1" size={"heading1"} className="text-white mb-[10px] 2xl:mb-[20px] 3xl:mb-[25px]">
            ...
            {offers_section?.button_url?.url && (
              <StyledLink href={offers_section?.button_url?.url} target={offers_section?.button_url?.target} className="lg:!py-[12px] 3xl:!py-[15px]">
              ...
              offers_section?.offers_list?.slice(1, 5).map((item, index) => (
                <div
                  ...
                  className={`md:absolute ${
                    ["top-0 left-0", "top-0 right-0 md:text-right", "bottom-0 left-0", "bottom-0 right-0 md:text-right"][index]
