        ...
        >
          <div className="container">
            <div className="w-full h-auto flex items-center justify-between relative z-0">
              ...
              <Link
                href={"/"}
                className="group h-auto w-[120px] lg:w-[156px] xl:w-[165px] 2xl:w-[220px] 3xl:w-[245px] absolute left-0 right-0 top-0 ml-auto lg:mx-auto will-change-transform"
              >
                <Image
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
              ...
              <div className="w-full h-full p-[20px] pt-0 overflow-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    {header_acf?.mega_menu?.address && (
                      <div className="w-full flex lg:items-center max-lg:flex-col max-sm:mb-[15px]">
                        <div className="text-[18px] sm:text-[20px] leading-[1] font-light font-base1 text-white max-lg:mb-[5px]">Address</div>
                ...
                {(() => {
                  ...
                  return isEnabled && validIcons.length > 0 ? (
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1 }} className="w-full py-4">
            ...
            >
              {isMenuOpen && <div className="fixed inset-0 -z-25 pointer-events-none" style={{ pointerEvents: "auto" }} onClick={closeMenu} />}
                  ...
                  <div className="w-full h-fit lg:h-auto pb-[25px] lg:pb-[35px] 2xl:pb-[45px] 3xl:pb-[60px] lg:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px] border-b-1 border-[#515151] flex flex-wrap">
                    ...
                    <div className="w-full lg:w-[30%] lg:pl-[4%]">
                      ...
                      {header_acf?.mega_menu?.enable__disable_social_media_links &&
                        (() => {
                          const validIcons = header_acf?.mega_menu?.social_media_icons?.filter((item) => item?.icon?.url && item?.link);
