...
export default function EnquiryForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const sourcePageTitle = typeof document !== "undefined" ? document.querySelector(".cartitle_hidden_value")?.value || "" : "";
      ...
      const sourcePageId = typeof window !== "undefined" ? window.location.pathname : "";
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/wp-json/custom/v1/enquiry`, {
        method: "POST",
        headers: {
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <input type="hidden" name="sourcePageId" value={typeof window !== "undefined" ? window.location.pathname : ""} />
        <input type="hidden" name="sourcePageTitle" value={typeof document !== "undefined" ? document.title : ""} />

        {/* Submit Button */}
        <div className="w-full flex justify-end">
          <StyledButton variant="fill" size="button1" type="submit" disabled={isSubmitting}>
