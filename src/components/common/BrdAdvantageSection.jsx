...
export default function BrdAdvantageSection({ data }) {
  ...
  const advantages_section = data?.advantages_section;
  ...
  return (
    advantages_section?.enable__disable_advantages_section?
      <section
        ref={sectionRef}
      ...
      >
        ...
        >
          {advantages_section?.vanishing_title}
        </motion.div>
        <div className="container">
          ...
          >
            ...
            <div className="w-full sm:w-1/2 sm:pl-[10%]">
              ...
              >
                {advantages_section?.description}
              </Text>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            ...
            >
              {advantages_section?.advantages_list?.map((item, index) => (
