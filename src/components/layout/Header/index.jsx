...
export default function Header() {
    ...
    const updateHeader = useCallback((current) => {
        ...
        <header>
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className={`w-full h-auto py-[25px] lg:py-[20px] 2xl:py-[25px] 3xl:py-[30px] fixed top-0 inset-x-0 z-2 ${isScrolled && visible
                    ...
                    <div className="container">
                        <div className="w-full h-auto flex items-center justify-between relative z-0">
                            ...
                            >
                                <Image src="/images/logo.svg" alt="logo" width={187} height={50} />
                            </Link>
                            <div className="hidden lg:flex items-center">
                                <a
                                    className="font-base3 mr-[10px]"
                                    href="">
                                    <span className="lg:text-[10px] 2xl:text-[13px] 3xl:text-[14px] leading-[1.5] font-normal text-[#706D6D] text-right block">Quick Contact</span>
                                    <span className="lg:text-[13px] 2xl:text-[15px] 3xl:text-[18px] leading-[1.5] font-normal text-white">+91 415‑555‑0132</span>
                                </a>
...
function MenuIcon() {
    ...
    return (
        <>
            ...
            <div
                ref={menuRef}
                className={`fixed top-[120px] right-0 w-full bg-white text-black z-50 shadow-2xl overflow-hidden transition-all duration-500 transform ${menuIsOpen ? 'max-h-[600px] opacity-100 scale-100' : 'max-h-0 opacity-0 scale-95 pointer-events-none'
                    }`}
            >
