...
//       >
//         <div className="group w-[30px] h-auto aspect-square relative z-0">
//           <div
//             className={`w-[30px] h-[15px] flex flex-col justify-between transition-all duration-500 ${
//               menuIsOpen ? "opacity-0" : "opacity-100"
//             }`}
//           >
//             <span className="w-[65%] h-[1px] bg-white"></span>
//             <span className="w-[40%] h-[1px] bg-white"></span>
//             <span className="w-full h-[1px] bg-white transition-all duration-500 group-hover:w-[20%]"></span>
//           </div>
//           <div
//             className={`w-[30px] h-[15px] absolute inset-0 flex flex-col justify-between transition-all duration-500 ${
...
//       <div
//         ref={menuRef}
//         className={`w-full max-lg:h-screen fixed z-50 top-0 lg:top-[var(--header-y)] lg:left-0 right-0 bottom-0 max-lg:bg-[#333333]/80 max-lg:backdrop-blur-[20px] transition-all duration-500 transform ${
//           menuIsOpen
//             ? "max-lg:translate-x-0 lg:max-h-[600px] opacity-100 scale-100 z-[-1000]"
//             : "max-lg:translate-x-[-100%] opacity-0  pointer-events-none"
//         }`}
//       >
...
//                     <Link
//                       href={item?.url}
//                       className="text-[18px] sm:text-[20px] lg:text-[16px] 2xl:text-[20px] 3xl:text-[25px] leading-[1.2] font-light font-base1 text-white mb-[10px] sm:mb-[15px] lg:mb-[15px] 3xl:mb-[20px] block"
//                     >
//                       {item?.label}
//                     </Link>
//                   </div>
