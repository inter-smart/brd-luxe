...
//   return (
//     <section className="w-full h-auto block py-[30px] sm:py-[60px] lg:py-[70px] 2xl:py-[90px] 3xl:py-[115px] relative z-0">
//       <div className="text-[32px] sm:text-[48px] md:text-[58px] lg:text-[64px] xl:text-[74px] 2xl:text-[88px] 3xl:text-[110px] leading-[1.5] font-light font-base1 text-white w-full h-full bg-black absolute inset-0 z-2  items-center justify-center hidden">
